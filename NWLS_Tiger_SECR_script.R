...
nwls_mask_2023 <- make.mask(traps(tiger_capthist_2023), buffer = 11250, spacing = 950, type = "trapbuffer", poly = NWLS, poly.habitat = TRUE)
plot(nwls_mask_2023)
...
# creating on-off matrix/trap matrix for camera trap stations to understand effort
NWLS_camop_table_2024 <- cameraOperation(NWLS_camop,
                                         stationCol = "station",
                                         setupCol = "Deployment",
                                         retrievalCol = "Retrieving",
                                         dateFormat = "%d-%m-%Y",
...
# creating a habitat Mask
nwls_mask_2024 <- make.mask(traps(tiger_capthist_2024), buffer = 9400, spacing =915, type = "trapbuffer", poly = NWLS, poly.habitat = TRUE)
plot(nwls_mask_2024)
